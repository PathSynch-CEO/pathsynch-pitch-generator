 ...
 * @param {string} [options.modelId] - Model to use (default: gemini-3-flash-preview)
 ...
 */
async function generateJSON(systemPrompt, userMessage, modelId = 'gemini-3-flash-preview') {
...
async function validateNarrative(systemPrompt, narrative, originalData, options = {}) {
    const { modelId = 'gemini-3-flash-preview' } = options;
...
async function formatNarrative(systemPrompt, narrative, assetType, options = {}) {
    const { modelId = 'gemini-3-flash-preview', branding = {} } = options;
